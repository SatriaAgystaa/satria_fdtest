    ...
    <div class="min-h-screen flex">
        <div class="hidden lg:block w-1/2 bg-gradient-to-br from-indigo-800 to-gray-800 relative">
            <div class="absolute inset-0 bg-opacity-50 bg-black flex items-center justify-center p-12">
                <div class="text-white max-w-md">
                    <h1 class="text-4xl font-bold mb-4">Temukan Buku Favorit Anda Selanjutnya</h1>
                    <p class="text-lg text-gray-300 mb-8">Bergabung dengan ribuan pembaca yang mengeksplorasi cerita menarik di <span class="text-white font-medium">Buku</span><span class="text-yellow-400 font-medium">Kita</span>.</p>
                    <div class="flex space-x-4">
                        <div class="w-12 h-1 bg-yellow-400 mt-3"></div>
                        <div>
                            <blockquote class="italic">"Pembaca hidup seribu hidup sebelum dia mati."</blockquote>
                            <p class="text-right text-gray-300 mt-2">- George R.R. Martin</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 bg-white flex items-center justify-center p-8">
            <div class="w-full max-w-md">
                ...
                <p class="text-center text-gray-600 mb-8">Masuk untuk melanjutkan perjalanan membaca Anda</p>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="flex items-center">
                        <input id="remember_me" type="checkbox" class="h-4 w-4 text-indigo-600 focus:ring-2 focus:ring-indigo-600 border-gray-300 rounded" name="remember">
                ...
                <div class="mt-8">
                    ...
                    <div class="mt-6 text-center">
                        <a href="{{ route('register') }}" class="inline-flex items-center font-medium text-indigo-600 hover:text-indigo-700">
                            {{ __('Buat akun baru') }}
